...
def main():
   ...
   #print "filename sum n trim_n min med mean max n50 n50_len ng50 ng50_len n90 n90_len ng90 ng90_len average_gene_size"
   ...
   for expr in sys.argv[2:len(sys.argv)]:
      for filename in glob.glob(expr):
         ...
         statNG50, statNG50Len = calcNXX(Lens, 50)
         statNG90, statNG90Len = calcNXX(Lens, 90)
 	 #statAGS = int(str(statSum) > AGS)
         ...
         print 'NG50 Contig', str(statNG50)
         print 'NG50 Length', str(statNG50Len)
         print 'N90 Contig', str(statN90)
         print 'N90 Length', str(statN90Len)
         print 'NG90 Contig', str(statNG90)
         print 'NG90 Length', str(statNG90Len)
